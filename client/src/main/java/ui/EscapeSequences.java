...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_OFF_WHITE = SET_TEXT_COLOR + "254m";
    ...
    public static final String SET_BG_COLOR_DARK_PINK = SET_BG_COLOR + "210m"; //#2D1F17
    public static final String SET_BG_COLOR_LIGHT_PINK = SET_BG_COLOR + "181m"; //#C4B6AB
    public static final String SET_BG_COLOR_BEIGE_GRAY = SET_BG_COLOR + "252m";
